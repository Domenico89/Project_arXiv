...
parser.add_argument('--max_index',type=int,default=500,help='upper bound on paper index we will fetch')
parser.add_argument('--results_per_iteration',type=int,default=100,help='passed to arxiv API')
parser.add_argument('--wait_time',type=float,default=5.0,help='waiting time between iterationsto avoid being cut out by arXiv API')
